...
import {
  platTransactionreportsListColumns,
  PlatTransactionReportsListData,
} from "../../../components/tables/platinum/download-reports/transactions-columns";
    ...
    <div>
      <div className="container mb-10">
        <div className="mb-10">
          ...
          <DataTable
            columns={platTransactionreportsListColumns}
            data={[]}
