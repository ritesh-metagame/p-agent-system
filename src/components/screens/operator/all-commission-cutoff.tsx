...
import { operatorAllCommissionCutoffColumns } from "../../../components/tables/operator/commission-release/all-commissions-cutoff-columns";

import type { OperatorAllCommissionCutoffData } from "../../../components/tables/operator/commission-release/all-commissions-cutoff-columns";
