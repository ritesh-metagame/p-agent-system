...
import {
  platsettlehistoryreportsListColumns,
  PlatsettlehistoryReportData,
} from "../../../components/tables/platinum/download-reports/settlement-history-columns";
...
export default function PlatinumSettlementHistory({}: Props) {
  return (
    <div>
      <div className="container mb-10">
        <div className="mb-10">
          ...
          <DataTable
            columns={platsettlehistoryreportsListColumns}
            data={[]}
